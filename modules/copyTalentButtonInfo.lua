...
--- @class TTT_CopyTalentButtonInfo: NumyConfig_Module, AceHook-3.0, NumyAceEvent-3.0
local Module = Main:NewModule('CopyTalentButtonInfo', 'AceHook-3.0', 'NumyAceEvent-3.0');
